...
using GodotFloorLevels.Scripts.GTweensGodot.Godot.Source.Tweeners;
...
using GodotFloorLevels.Scripts.GTweensGodot.GTweens.Source.TweenBehaviours;
...
public static class GTweenGodotExtensions
{
    ...
    public static GTween Tween(
        Tweener<double>.Getter getter, 
        Tweener<double>.Setter setter,
        Tweener<double>.Getter to, 
        float duration, 
        ValidationDelegates.Validation validation
    )
    {
        InterpolationTweenBehaviour tweenBehaviour = new InterpolationTweenBehaviour();
        tweenBehaviour.Add(new GodotDoubleTweener(getter, setter, to, duration, validation));
        return new GTween(tweenBehaviour);
    }
